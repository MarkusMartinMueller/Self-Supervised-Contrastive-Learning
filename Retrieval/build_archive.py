...
from models import TwoBranch, get_model
...
def build_db(filename, state_dict_path,state):
    ...
    pickle.dump(feature_dict, open("archive_db.p", "wb"))


if __name__ == '__main__':
    build_db(filename="/logs/Resnet50/first_test/parameters.yaml", state_dict_path="/logs/Resnet50/first_test/checkpoints_model_best.pth.tar", state="val")
    #feature_dict = pickle.load(open("archive_db.p", "rb"))
